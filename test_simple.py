...
def parse_args():
    ...
    parser.add_argument("--lora_type",
                        ...
                        choices=["lora", "dvlora", "none","dynamic_lora","multiscale_lora"],
                        default="dynamic_lora")
...
def test_simple(args):
    ...
    if args.model_type == 'endodac':
        ...
        depther_dict = torch.load(depther_path, map_location=device)  # 改 Ensure it loads to correct device
    ...
    if args.model_type == 'endodac':
        ...
        # depther.cuda()                                            # 改 Ensure it loads to correct device
        depther.to(device)
        depther.eval()
    elif args.model_type == 'afsfm':
